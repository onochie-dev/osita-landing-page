      ...
      >
        ...
        <div className="bg-neutral-900 rounded-2xl p-8 shadow-xl">
          <div className="text-center mb-6">
            ...
            <p className="text-neutral-400 mt-1">Start your CBAM compliance journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 mt-1.5">Letters, numbers, and underscores only</p>
            </div>
  ...
  return (
    <div className="flex items-center gap-2 text-xs">
      <div className={`w-4 h-4 rounded-full flex items-center justify-center ${
        checked ? 'bg-white text-neutral-900' : 'bg-neutral-700 text-neutral-500'
      }`}>
        {checked && <Check className="w-3 h-3" />}
      </div>
      <span className={checked ? 'text-white' : 'text-neutral-500'}>{label}</span>
    </div>
  )
}
