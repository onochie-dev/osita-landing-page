    ...
    <div className="min-h-screen bg-osita-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-osita-900 flex items-center justify-center shadow-lg">
              <span className="text-white font-bold text-xl">O</span>
            </div>
            <span className="text-3xl font-display text-osita-900">OSITA</span>
          </motion.div>
          <p className="text-body text-osita-500">CBAM Compliance Engine</p>
        </div>
        ...
        >
          ...
          <div className="relative">
            <div className="text-center mb-8">
              <h1 className="text-display-sm font-display text-white">Welcome back</h1>
              <p className="text-body text-osita-400 mt-2">Sign in to your account</p>
            </div>
        ...
        <motion.p
          ...
          className="text-center text-caption text-osita-400 mt-8"
        >
